...
::: {.incremental style="margin-top: 0.1em; font-size: 0.675em;"}
...
- {{< iconify fa6-solid magnifying-glass >}} **Choose the right search method**
  - Use linear search for small collections and binary search for large,
    sorted indexes
  - Consider full-text search or indexing for complex queries
...
- {{< iconify fa6-solid rocket >}} **Balance correctness and efficiency**
  ...
  - Understand algorithmic complexity (Big-O) when data scales
