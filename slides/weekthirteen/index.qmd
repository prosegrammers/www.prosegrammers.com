...
# Natural language processing for prosegrammers
...
- {{< iconify fa6-solid book >}} **What are this week's highlights?**
    - Implement fundamental NLP techniques from scratch
...
- {{< iconify fa6-solid gears >}} Natural language processing transforms
raw text into structured data that programs can analyze
- {{< iconify fa6-solid book >}} Simple algorithms handle common NLP
tasks without external libraries
- {{< iconify fa6-solid code >}} Understanding basic NLP helps
prosegrammers build powerful document analysis tools
...
- {{< iconify fa6-solid bullhorn >}} This week's content aids attainment
of **CS-104-3**!
...
individual units called tokens
  ...
  - Simple approach uses whitespace splitting
...
- Split text on whitespace to create list of tokens
- Simple but effective for basic text analysis
- **What happens to punctuation in this approach?**

:::

## Advanced tokenization with punctuation
...
def tokenize_words(text: str) -> List[str]:
    """Extract words only, removing punctuation."""
    pattern = r'\b\w+\b'
...
doc = "Hello world. This is NLP. Isn't it great?"
...
- **Consider edge cases like abbreviations**
...
- Common convention in plain text documents
...
- {{< iconify fa6-solid cut >}} **Stemming** reduces words to their
root form by removing suffixes
  - "running" becomes "run", "happily" becomes "happi"
...
to their dictionary form
  ...
  - More accurate but requires linguistic knowledge
  - We'll implement simple rule-based stemming
...
- Remove common English suffixes in priority order
- Preserve minimum word length to avoid over-stemming
- **Simple but effective for basic text normalization**
...
- More accurate than stemming for known words
...
## Analyzing text with stop word removal
...
- Reveals key topics in the document

:::

# Word frequency analysis: counting term occurrences

::: {.incremental style="margin-top: -0.25em; font-size: 0.725em;"}

- {{< iconify fa6-solid chart-bar >}} **Word frequency** counts how
...
- {{< iconify fa6-solid lightbulb >}} **Applications for
prosegrammers**
...
doc = "document engineering with python for document analysis and
python programming"
top = top_words(doc, 3)
print("Top 3 words:")
...
doc = "python programming is fun and python is great for document
engineering"
...
- {{< iconify fa6-solid search >}} **Keyword in context (KWIC)** shows
...
def keyword_in_context(text: str, keyword: str, context: int = 3) ->
...
doc = "Python is great. I love Python programming. Python makes
coding fun."
...
def format_kwic(text: str, keyword: str, width: int = 20) ->
List[str]:
...
doc = "Document engineering needs Python. Python helps with
documents. Use Python daily."
...
- {{< iconify fa6-solid search >}} **Understand context and usage**
