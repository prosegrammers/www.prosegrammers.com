...
Kacper Łukawski on Qdrant Vector
...
::: {.incremental style="margin-top: -0.45em; font-size: 0.7em;"}
...
::: {.incremental style="margin-top: -0.8em; font-size: 0.775em;"}
...
::: {.incremental style="margin-top: -0.35em; font-size: 0.7em;"}
...
template-based generation to demonstrate the concept without requiring external
APIs or packages. This approach generates an interesting result! Yet, not
general-purpose enough to be used in a production RAG tool.
...
chunks = ["Prosegrammers combine programming and writing skills", "Prosegrammers use Python to create and analyze documents", "Document tools automate content creation", "Achieve learning objectives in document engineering"]
retrieved = retrieve_chunks(query, chunks, top_k=2)
...
docs = ["Students use a laptop computer for document engineering. The laptop is equipped with software like VSCode and a terminal window.", "Document engineering uses Python to analyze text. Tools help automate writing tasks.", "Prosegrammers combine programming skills with technical writing. They create better documentation systems.", "They achieve learning objectives and attend class."]
