...
- **Apply pattern**: use methods like `match()`, `search()`, or `findall()`
...
::: {.fragment style="margin-top: -0.05em; font-size: 0.825em;"}

- {{< iconify fa6-solid lightbulb >}} **Try modifying**: can you make the
hyphens optional? What about allowing dots or spaces as separators?
...
- {{< iconify fa6-solid rocket >}} **Quantifiers**: specify repetition
...
::: {.fragment .fade .boxed-content style="margin-top: 0.15em; font-size: 0.9em;"}

{{< iconify fa6-solid microscope >}} These building blocks combine to create
powerful patterns for document processing!
...
## Explore quantifiers interactively
...
`\d+` or `\d*` to see how matching behavior changes!
...
- {{< iconify fa6-solid search >}} **Search**: find pattern anywhere in string
- {{< iconify fa6-solid bullseye >}} **Match**: check if pattern starts string
- {{< iconify fa6-solid list >}} **Find all**: extract all matches
...
versions, IDs
- {{< iconify fa6-solid filter >}} **Validate input**: check format compliance
- {{< iconify fa6-solid text-slash >}} **Clean text**: remove unwanted patterns
- {{< iconify fa6-solid magnifying-glass >}} **Analyze content**: find
patterns in docs
